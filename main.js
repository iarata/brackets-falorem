define(function (require, exports, module) {
  ...
  var file = require('fa.lorem').split('\n')
  ...
  function checkBeforeCursor(editor, text) {
    ...
    var ghabl = editor.document.getRange({ch: cursor.ch - farsilorem.length, line: cursor.line}, cursor)
    return ghabl === text
  }
  ...
  var farsilorem = 'falorem',
      lastChars = [farsilorem[farsilorem.length-1]]
  ...
  function hasHints(editorParam, implicitChar) {
    ...
    editor = editorParam
    return checkBeforeCursor(editor, farsilorem)
  }
  ...
  function insertHint(hint) {
    ...
    var regex = new RegExp(`${farsilorem}(\\d*)$`, 'i')
    var matchedLength = 0
    var wordsCount = 0
